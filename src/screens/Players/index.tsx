...
export function Players() {
  ...
  async function fetchPlayersByTeam() {
    try {
      ...
      Alert.alert("People", "Do not be possible load people");
    }
  }
  ...
  async function handlePlayerRemove(playerName: string) {
    try {
      ...
      Alert.alert("Remove Person", "Do not be possible remove this person");
    }
  }
  ...
  async function groupRemove() {
    try {
      ...
      Alert.alert("Remove Group", "Do not be possible remove group");
    }
  }

  async function handleGroupRemove() {
    Alert.alert("Remove", "Do you want remove this group?", [
